...
BUILDER(ATOM_ANALY_MIPS, AnalyMIPSDisassembler, AnalyDisassembler)
...
bool init_analyser()
{
	...
	REGISTER(ATOM_ANALY_MIPS, AnalyMIPSDisassembler)
...
void done_analyser()
{
	...
	UNREGISTER(ATOM_ANALY_MIPS, AnalyMIPSDisassembler)
