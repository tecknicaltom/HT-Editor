...
ObjectID AnalyMIPSDisassembler::getObjectID() const
{
	return ATOM_ANALY_MIPS;
}
...
Address *AnalyMIPSDisassembler::createAddress(uint64 offset)
{
 ...
 *
 */
void AnalyMIPSDisassembler::examineOpcode(OPCODE *opcode)
{
}
 ...
 *
 */
branch_enum_t AnalyMIPSDisassembler::isBranch(OPCODE *opcode)
{
