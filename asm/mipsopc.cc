...
#define CtrlReg TrapCode + 1
  { 5, 11, 0, 0, 0, MIPS_OPERAND_CTRLREG },
...
{ "cfc1",   OP_MASK|OP_FMT_MASK|OP_FUNCTION_MASK|OP_FUNCTION_EXT_MASK,  OPCODE(0x11)|FMT(0x02)|FUNCTION(0)|FUNCTION_EXT(0),  {Rt, CtrlReg} },
{ "mtc1",   OP_MASK|OP_FMT_MASK|OP_FUNCTION_MASK|OP_FUNCTION_EXT_MASK,  OPCODE(0x11)|FMT(0x04)|FUNCTION(0)|FUNCTION_EXT(0),  {Rt, Fs} },
{ "ctc1",   OP_MASK|OP_FMT_MASK|OP_FUNCTION_MASK|OP_FUNCTION_EXT_MASK,  OPCODE(0x11)|FMT(0x06)|FUNCTION(0)|FUNCTION_EXT(0),  {Rt, CtrlReg} },
