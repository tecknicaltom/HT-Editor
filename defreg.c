...
char default_reg[1631] = {
	0x00,0x00,0x18,' ', 0x00,0x00,0x06,'W', 
	0x00,'I', 'R', 'E', 'G', 0x00,'D', 'A', 
	'T', '!', 'D', 'A', 'T', 0xc0,0x00,0x00,
	0x00,0x06,'R', 'E', 'G', 0x10,0x00,0x00,
	0x00,0x03,'d', 'w', 'o', 'r', 'd', 0x00,
	'R', 'E', 'G', '"', 0x00,0x00,0x01,0x00,
	'p', 'a', 'l', 'e', 't', 't', 'e', 0x00,
	'P', 'A', 'L', 0x10,0x00,0x00,0x00,0x05,
	'r', 'a', 'w', 0x00,'R', 'E', 'G', '$', 
	0x00,0x00,0x00,0x04,'s', 't', 'r', 'i', 
	'n', 'g', 0x00,'R', 'E', 'G', '#', 0x00,
	0x00,0x00,0x01,'s', 'u', 'b', 'd', 'i', 
	'r', 0x00,0x00,0x00,0x00,'h', 0x00,0x05,
	0x02,'s', 'y', 'm', 'l', 'i', 'n', 'k', 
	'd', 0x09,0x07,'!', 'R', 'E', 'G', 0x01,
	0x00,0x00,0x00,0x01,'/', 'v', 0x01,0x02,
	'D', '(', 0xd5,0x01,0x02,0xe4,0x03,0x03,
	'c', 'o', 'n', 'f', 'i', 'g', '7', 'x', 
	0x00,0x03,'e', 'd', 'i', 't', 'o', 'r', 
	'.', 'y', 0x00,0x05,0xd4,0x07,0x01,0x04,
	'E', 'O', 'F', 'l', 0x03,0x03,0x05,'<', 
	'E', 'O', 'F', '>', 't', 0x0f,0x01,0x04,
	'E', 'O', 'L', 0x85,0x02,'.', 't', 0x01,
	0x09,0x03,'a', 'u', 't', 'o', ' ', 'i', 
	'n', 'd', 'e', 'n', 't', 'u', 0x02,0x03,
	'l', 0x11,'l', 0x1d,0x09,'s', 'c', 'r', 
	'o', 'l', 'l', ' ', 'o', 'f', 'f', 's', 
	'e', '\'','d', 0x00,0x84,0x06,0x05,'t', 
	'a', 'b', ' ', 's', 'i', 'z', 'e', 0xf9,
	0x05,0x08,'h', 0x06,0x01,'m', 'i', 's', 
	'c', '`', 0x02,'*', 0x05,0x03,0x03,0xcd,
	0x10,0x03,0xa4,0x18,0x03,' ', 'f', 'o', 
	'r', 'm', 'a', '\'',',', 0x01,'t', 0x1e,
	0x07,0x04,'s', 't', 'a', 't', 'u', 's', 
	'l', 'i', 'n', 0x94,0x09,0x09,0x05,'%', 
	'a', ' ', '%', 'L', ' ', '%', 't', ' ', 
	'%', 'd', 'h', 0x0d,0x09,0x04,'v', 'f', 
	's', ' ', 'd', 'i', 's', 'p', 'l', 'a', 
	'y', ')', 0xf4,0x00,0x00,0x07,0x05,'t', 
	'y', 'p', 'e', ',', 'n', 'a', 'm', 'e', 
	':', '2', '0', '+', ',', '|', ',', 'd', 
	'e', 's', 'c', ',', '|', ',', 'b', 't', 
	0x12,0x0d,',', '|', ',', 'p', 'e', 'r', 
	'm', ',', '|', ',', 'r', 'm', 't', 'i', 
	'm', 'e', '}', 0x08,0x01,0xeb,'5', 'R', 
	'E', 'G', '*', 0x81,0x02,0x04,0xc0,0x14,
	0x06,0x01,'a', 'n', 'a', 'l', 'y', 's', 
	'e', 'r', '.', 0x05,0x03,0x01,0xe0,0x04,
	0x03,'d', 'e', 'f', 'a', 'u', 'l', 0x8c,
	0x17,'*', 0x00,0x01,'e', 'C', 0x01,'l', 
	'A', 0x01,'c', 'o', 'm', 'm', 'g', '(', 
	'P', 'A', 'L', '`', 0x0e,0x02,0x00,0x00,
	0x00,0x07,0x08,'|', 0x02,0xfc,0x06,'(', 
	']', 0x00,0x82,0x9c,0x02,0x03,'l', 'a', 
	'b', 'e', 'l', 0x00,'(', 'U', 0x00,0x86,
	0x94,0x02,0x03,'n', 'u', 'm', 'b', 'e', 
	'r', ')', 'Y', 0x00,0x03,0x99,0x02,'s', 
	0xb0,'I', '(', 0xb5,0x00,0x84,0xb8,0x02,
	0x0a,'y', 'm', 'b', 'o', 'l', '-', 'c', 
	'h', 'a', 'r', 'a', 'c', 't', '+', 0xdd,
	0x00,0x83,0x8c,'2', 0x03,'g', 'e', 'n', 
	'e', 'r', 'i', '/', 'Y', 0x06,0x0c,0xf0,
	0x1a,0x01,'b', 'l', 'a', 'c', 0x90,'P', 
	...
	0x0b,0x04,'c', 'l', 'u', 's', 't', 'e', 
	'r', '2', 0xf9,0x01,0x03,'x', 0x0f,0xfe,
	0x03,'s', 'h', '/', 0x85,0x01,0x86,'+', 
	0x80,0x00,'3', 0x88,0x01,0x84,0x04,0x02,
	'f', 'r', 'a', 'm', 'e', '1', 0x80,0x01,
	0xb8,'9', 0xb4,0x03,0x01,'k', 'i', 'l', 
	'l', '+', 0xb9,0x05,0x02,0x98,0x1b,0xb0,
	0x03,0x05,'m', 'o', 'v', 'e', '-', 'r', 
	'e', 's', '`', 'd', '(', 0xc4,0x06,0xb4,
	'>', 0xa4,0x04,'2', 0xf0,0x01,0xb8,0x0b,
	0x07,'i', 'n', 'p', 'u', 't', ' ', 'c', 
	'l', 'i', 'p', 0x95,':', 's', ')', 0x85,
	0x04,0x82,0x98,'L', 0xa0,0x04,'0', 'y', 
	...
	'?', '/', 0xa4,0x00,'3', 'T', 0x01,'j', 
	'k', 0x01,0x00,0xa6,0x93,'b', 'a', '*', 
	...
	0x0d,'+', 'a', 0x05,0x80,'#', 'C', '\'',
	's', 'e', 'l', 'l', 0x12,'*', 0x14,0x02,
	0x84,'1', 0xdc,0x02,0xec,0x15,'1', 0xd8,
	0x1c,0x80,0xb4,'-', 0x98,0x00,'*', 0xac,
	0x02,0x07,'L', 0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x03,0x11,0x00,0x00
};
